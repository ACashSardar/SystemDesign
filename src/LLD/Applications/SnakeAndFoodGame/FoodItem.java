...
// This abstract class represents a food item placed on the game board.
// It defines the common properties such as position (row, column) and the points awarded when consumed.
